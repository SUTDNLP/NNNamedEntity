...
#ifndef SRC_DLSTMLABELER_H_
#define SRC_DLSTMLABELER_H_


#include "N3L.h"
#include "basic/DLSTMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  DLSTMClassifier<gpu> m_classifier;
  DLSTMClassifier<gpu> last_classifier;

#else
  DLSTMClassifier<cpu> m_classifier;
  DLSTMClassifier<cpu> last_classifier;
#endif
