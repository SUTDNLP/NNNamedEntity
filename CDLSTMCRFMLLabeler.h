...
#ifndef SRC_CDLSTMCRFMLLABELER_H_
#define SRC_CDLSTMCRFMLLABELER_H_


#include "N3L.h"
#include "basic/CDLSTMCRFMLClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  CDLSTMCRFMLClassifier<gpu> m_classifier;
  CDLSTMCRFMLClassifier<gpu> last_classifier;

#else
  CDLSTMCRFMLClassifier<cpu> m_classifier;
  CDLSTMCRFMLClassifier<cpu> last_classifier;
#endif
...
#endif /* SRC_CDLSTMCRFMLLABELER_H_ */
