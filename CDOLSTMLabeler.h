...
#ifndef SRC_CDOLSTMLABELER_H_
#define SRC_CDOLSTMLABELER_H_


#include "N3L.h"
#include "basic/CDOLSTMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  CDOLSTMClassifier<gpu> m_classifier;
  CDOLSTMClassifier<gpu> last_classifier;

#else
  CDOLSTMClassifier<cpu> m_classifier;
  CDOLSTMClassifier<cpu> last_classifier;
#endif
