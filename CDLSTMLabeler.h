...
#ifndef SRC_CDLSTMLABELER_H_
#define SRC_CDLSTMLABELER_H_


#include "N3L.h"
#include "basic/CDLSTMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  CDLSTMClassifier<gpu> m_classifier;
  CDLSTMClassifier<gpu> last_classifier;

#else
  CDLSTMClassifier<cpu> m_classifier;
  CDLSTMClassifier<cpu> last_classifier;
#endif
