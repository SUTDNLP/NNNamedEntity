...
#ifndef SRC_DLSTMCRFMLClassifier_H_
#define SRC_DLSTMCRFMLClassifier_H_
...
public:
  ...
  inline dtype secondprocess(const vector<Example>& examples, const vector<Example>& last_examples, DLSTMCRFMLClassifier last_classifier,  int iter) {
  ...
  void secondpredict(const vector<Feature>& features, const vector<Feature>& last_features, DLSTMCRFMLClassifier last_classifier, vector<int>& results) {
  ...
  dtype secondcomputeScore(const Example& example, const Example& last_example, DLSTMCRFMLClassifier last_classifier) {
  ...
  void secondcheckgrad(const vector<Example>& examples, const vector<Example>& last_subExamples, DLSTMCRFMLClassifier last_classifier, Tensor<xpu, 2, dtype> Wd, Tensor<xpu, 2, dtype> gradWd, const string& mark, int iter) {
    int charseed = mark.length();
    for (int i = 0; i < mark.length(); i++) {
      charseed = (int) (mark[i]) * 5 + charseed;
    }
  ...
  void secondcheckgrads(const vector<Example>& examples, const vector<Example>& last_subExamples, DLSTMCRFMLClassifier last_classifier, int iter) {
